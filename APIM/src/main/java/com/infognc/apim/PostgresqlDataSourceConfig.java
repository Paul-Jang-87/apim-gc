...
@EnableJpaRepositories(basePackages = "com.infognc.apim.repositories.postgre", // 참고할 repository
...
*/	
	...
	public LocalContainerEntityManagerFactoryBean postgresqlEntityManagerFactory(EntityManagerFactoryBuilder builder,
		...
		return builder.dataSource(dataSource).packages("com.infognc.apim.entities.postgre")// 참고할 엔티티
